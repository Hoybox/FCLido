...
const quickLinks = [
  ...
  { page: Page.Calendar, icon: <CalendarIcon />, imageUrl: 'https://i.ibb.co/gFSSBKN/Cat-Calendrier.jpg' },
  { page: Page.Club, icon: <BuildingLibraryIcon />, imageUrl: 'https://i.ibb.co/4Z6GTBf/Cat-Club.jpg' },
  { page: Page.Panini, icon: <TicketIcon />, imageUrl: 'https://i.ibb.co/mr8G8qy/Cat-Panini.jpg' },
